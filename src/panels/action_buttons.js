...
// Pixel grid with some cells filled in
makeActionButtonIcon.pixelPen = () => {
	let re = `
		<g data-name="Snap to pixel grid">
			<rect x="4" y="4" width="4" height="4" fill="${icon.actionLightBlue}"/>
			<rect x="8" y="8" width="4" height="4" fill="${icon.actionLightBlue}"/>
			<rect x="12" y="12" width="4" height="4" fill="${icon.actionLightBlue}"/>
			<g fill="${icon.actionDarkBlue}">
				...
				<rect x="3" y="4" width="1" height="12"/>
				<rect x="8" y="4" width="1" height="12"/>
				<rect x="12" y="4" width="1" height="12"/>
				<rect x="16" y="4" width="1" height="12"/>
			</g>
		</g>
	`;
...
// Two glyphs with a linked measurement between them
makeActionButtonIcon.metricKeys = () => {
	let re = `
		<g data-name="Update metric keys">
			<rect x="2" y="4" width="4" height="12" fill="${icon.actionLightBlue}"/>
			<rect x="14" y="4" width="4" height="12" fill="${icon.actionLightBlue}"/>
			<g fill="${icon.actionDarkBlue}">
				<rect x="6" y="9" width="8" height="2"/>
				<polygon points="6 10 9 7 9 13 6 10"/>
				<polygon points="14 10 11 7 11 13 14 10"/>
				<rect x="1" y="2" width="1" height="16"/>
				<rect x="18" y="2" width="1" height="16"/>
			</g>
		</g>
	`;
