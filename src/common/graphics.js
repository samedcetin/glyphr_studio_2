...
// A base anchor ring with a mark's cross above it
icons.panel_anchors = `
	<path d="M12,13c-2.2,0-4,1.8-4,4s1.8,4,4,4,4-1.8,4-4-1.8-4-4-4ZM12,19c-1.1,0-2-.9-2-2s.9-2,2-2,2,.9,2,2-.9,2-2,2Z"/>
	<polygon points="13 0 11 0 11 5 6 5 6 7 11 7 11 12 13 12 13 7 18 7 18 5 13 5 13 0"/>
`;

icons.panel_transforms = `
	<path d="M8,7v-2h-3v3h2v8h-2v3h3v-2h8v2h3v-3h-2v-8h2v-3h-3v2h-8ZM6,7v-1h1v1h-1ZM7,18h-1v-1h1v1ZM15,15h-6v-6h6v6ZM18,17v1h-1v-1h1ZM17,6h1v1h-1v-1Z" />
	<path d="M24,3V0h-3v2h-7V0h-4v2H3V0H0v3h2v7H0v4h2v7H0v3h3v-2h7v2h4v-2h7v2h3v-3h-2v-7h2v-4h-2V3h2ZM22,1h1v1h-1v-1ZM11,1h2v1h-2v-1ZM1,2v-1h1v1h-1ZM1,13v-2h1v2h-1ZM2,23h-1v-1h1v1ZM13,23h-2v-1h2v1ZM23,22v1h-1v-1h1ZM23,11v2h-1v-2h1ZM21,10v11H3V3h18v7Z" />
	<path d="M14,10h-4v4h4v-4ZM13,13h-2v-2h2v2Z" />
	<path d="M-24,9v6h-6v-6h6M-22,7h-10v10h10V7h0Z" />
	<path d="M-21,6v1h-1v-1h1M-20,5h-3v3h3v-3h0Z" />
	<path d="M-16,1v1h-1v-1h1M-15,0h-3v3h3V0h0Z" />
	<path d="M-16,22v1h-1v-1h1M-15,21h-3v3h3v-3h0Z" />
	<path d="M-37,22v1h-1v-1h1M-36,21h-3v3h3v-3h0Z" />
	<path d="M-37,1v1h-1v-1h1M-36,0h-3v3h3V0h0Z" />
	<path d="M-37,11v2h-1v-2h1M-36,10h-3v4h3v-4h0Z" />
	<path d="M-16,11v2h-1v-2h1M-15,10h-3v4h3v-4h0Z" />
	<path d="M-26,22v1h-2v-1h2M-25,21h-4v3h4v-3h0Z" />
	<path d="M-26,1v1h-2v-1h2M-25,0h-4v3h4V0h0Z" />
	<path d="M-26,11v2h-2v-2h2M-25,10h-4v4h4v-4h0Z" />
	<path d="M-18,3v18h-18V3h18M-17,2h-20v20h20V2h0Z" />
	<path d="M-21,17v1h-1v-1h1M-20,16h-3v3h3v-3h0Z" />
	<path d="M-32,17v1h-1v-1h1M-31,16h-3v3h3v-3h0Z" />
	<path d="M-32,6v1h-1v-1h1M-31,5h-3v3h3v-3h0Z" />
`;
...
icons.panel_qualityChecks = `
	<path d="M10.577,16.801l-.229-.319c-.047-.065-.123-.105-.204-.105-.042,0-.082.01-.119.031l-.344.189c-.258.141-.548.216-.839.216-.738,0-1.379-.458-1.634-1.125l-3.208,6.415,2.846-.949.949,2.846,3.349-6.699c-.22-.124-.417-.29-.567-.5Z"/>
	<path d="M15.159,16.812c-.291,0-.581-.075-.839-.216l-.344-.189c-.037-.02-.078-.031-.12-.031-.082,0-.156.038-.204.105l-.229.319c-.15.21-.347.376-.567.5l3.349,6.699.949-2.846,2.846.949-3.208-6.415c-.255.667-.896,1.125-1.634,1.125Z"/>
	<circle cx="12" cy="8.5" r="5.125"/>
	<path d="M19.588,9.163c-.336-.379-.336-.948,0-1.327l.26-.294c.455-.513.27-1.321-.362-1.586l-.362-.152c-.467-.195-.714-.709-.576-1.195l.107-.378c.187-.659-.33-1.307-1.014-1.272l-.392.02c-.505.026-.951-.329-1.037-.827l-.067-.387c-.118-.675-.864-1.035-1.465-.706l-.344.189c-.444.243-.999.116-1.294-.295l-.229-.319c-.399-.557-1.228-.557-1.626,0l-.229.319c-.294.411-.85.538-1.294.295l-.344-.189c-.601-.329-1.348.03-1.465.706l-.067.387c-.087.498-.532.854-1.037.827l-.392-.02c-.685-.036-1.201.612-1.014,1.272l.107.378c.138.487-.109,1-.576,1.195l-.362.152c-.632.265-.817,1.073-.362,1.586l.26.294c.336.379.336.948,0,1.327l-.26.294c-.455.513-.27,1.321.362,1.586l.362.152c.467.195.714.709.576,1.195l-.107.378c-.187.659.33,1.307,1.014,1.272l.392-.02c.505-.026.951.329,1.037.827l.067.387c.118.675.864,1.035,1.465.706l.344-.189c.444-.243.999-.116,1.294.295l.229.319c.399.557,1.228.557,1.626,0l.229-.319c.294-.411.85-.538,1.294-.295l.344.189c.601.329,1.348-.03,1.465-.706l.067-.387c.087-.498.532-.854,1.037-.827l.392.02c.685.036,1.201-.612,1.014-1.272l-.107-.378c-.138-.487.109-1,.576-1.195l.362-.152c.632-.265.817-1.073.362-1.586l-.26-.294ZM12,14.375c-3.24,0-5.875-2.636-5.875-5.875s2.635-5.875,5.875-5.875,5.875,2.636,5.875,5.875-2.635,5.875-5.875,5.875Z"/>
`;

icons.panel_characterInfo = `
	<path d="M12,2c5.514,0,10,4.486,10,10s-4.486,10-10,10S2,17.514,2,12,6.486,2,12,2M12,0C5.373,0,0,5.373,0,12s5.373,12,12,12,12-5.373,12-12S18.627,0,12,0h0Z"/>
	<circle cx="12" cy="7" r="2.2"/>
	<rect x="10" y="11" width="4" height="9" rx="1" ry="1"/>
`;
...
// A grid of icon tiles - what a Private Use Area set looks like laid out.
icons.command_icons = `
