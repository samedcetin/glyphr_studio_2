...
export default {
	project: {
		name: {
			label: `Project name`,
			description: `Name for this project. Can be different than the Font or Font Family name. Also, this will be used as the name of the saved ${PRODUCT_NAME} Project (.gs2) file.`,
		},
		latestVersion: {
			label: `Version`,
	...
	font: {
		...
		overshoot: {
			...
			<br>Note: This is used internally by ${PRODUCT_NAME}, it is not exported to fonts.`,
			type: `Em`,
		},
		lineGap: {
			label: `Line gap`,
	...
	app: {
		...
		formatSaveFile: {
			...
			description: `${PRODUCT_NAME} Project files (.gs2) are text files in JSON format. By default, this file is saved to optimize for smaller file size. Setting this option to true formats the file to be more easily read by a human, but could increase the file size by 2x or more.`,
			type: `Boolean`,
		},
		saveLivePreviews: {
		...
		autoSave: {
			...
			description: `When enabled, this option will use your browser's local storage to keep backups. These backups can be restored from the Open Projects page. Your browser's local storage is confined to this browser on this computer. If you use ${PRODUCT_NAME} from another browser or on another computer, those backups will be available from there.`,
			type: `Boolean`,
		},
		savePreferences: {
